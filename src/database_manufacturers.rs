...
impl StandardDatabase {
    ...
    pub fn init_manufactures(&mut self) {
        ...
        self.add_standard_manufacture(0x0000CC, String::from("Bosch Home Comfort Japan, Inc."));
        ...
        self.add_standard_manufacture(0x000143, String::from("Deye Energy Japan Co., Ltd."));
        ...
        self.add_standard_manufacture(0x000141, String::from("DAIKO ELECTRIC CO.,LTD."));
        ...
        self.add_standard_manufacture(0x00013F, String::from("Energy Pool Japan K.K."));
        ...
        self.add_standard_manufacture(
            0x0000B8,
            String::from("Hokkaido Electric Power Network, Inc."),
        );
        self.add_standard_manufacture(
            0x0000BB,
        ...
        self.add_standard_manufacture(0x0000B0, String::from("idea co.,ltd. "));
        ...
        self.add_standard_manufacture(0x000140, String::from("Landis+Gyr AG"));
        ...
        self.add_standard_manufacture(0x00010D, String::from("Shizen Connect Inc."));
        ...
        self.add_standard_manufacture(0x000016, String::from("Toshiba Corporation"));
        self.add_standard_manufacture(
            0x000043,
        ...
        self.add_standard_manufacture(0x000142, String::from("Yanekara Inc"));
