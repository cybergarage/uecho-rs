...
impl StandardDatabase {
    ...
    pub fn init_objects(&mut self) {
        ...
        obj.add_standard_property(
            ...
            "".to_string(),
            0,
            to_attribute("required"),
            to_attribute("optional"),
            to_attribute("required"),
        );
        obj.add_standard_property(
            0x81,
        ...
        obj.add_standard_property(0xD4, "This property indicates the purpose of the showcase, either refrigeration or freezing.".to_string(), "".to_string(), 0, to_attribute("required"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(
            0xE0,
        ...
        obj.add_standard_property(0xE5, "Indicates rated power consumption when heater is operating during showcase defrosting.".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(
            0xE6,
        ...
        obj.add_standard_property(0xB2, "Channel range specification for cumulative amount of electric power consumption measurement (simplex)".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("optional"), to_attribute("optional"));
        obj.add_standard_property(
            0xB3,
        ...
        obj.add_standard_property(0xB9, "Channel range specification for cumulative amount of electric power consumption measurement (duplex)".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("optional"), to_attribute("optional"));
        obj.add_standard_property(
            0xBA,
        ...
        obj.add_standard_property(0xC5, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("optional"), to_attribute("optional"));
        obj.add_standard_property(
            0xC6,
        ...
        obj.add_standard_property(0xCA, "Measurement data of reactive electric power consumption (lag) for power factor measurement".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xCB, "Measurement data of cumulative amount of reactive electric power consumption (lag) at fixed time for power factor measurement".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xCC, "Number of effective digits for measurement data of cumulative amount of reactive electric power consumption (lag) for power factor measurement".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xCD, "Unit of measurement data of cumulative amount of reactive electric power consumption (lag)".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xCE, "Historical data of measurement data of cumulative amount of reactive electric power consumption (lag) for power factor measurement".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(
            0xD3,
        ...
        obj.add_standard_property(0xE1, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, to_attribute("required"), to_attribute("required"), to_attribute("optional"));
        obj.add_standard_property(
            0xE2,
        ...
        obj.add_standard_property(0xE4, "Measurement data of cumulative amounts of active electric energy for power factor measurement".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(
            0xE5,
        ...
        obj.add_standard_property(0xE0, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, to_attribute("required"), to_attribute("required"), to_attribute("optional"));
        obj.add_standard_property(
            0xE1,
            "Measured cumulative amount of electric energy(normal direction)".to_string(),
            "".to_string(),
        ...
        obj.add_standard_property(0xE2, "Historical data of measured cumulative amounts of electric energy 1 (normal direction)".to_string(), "".to_string(), 0, to_attribute("required"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(
            0xE3,
            "Measured cumulative amount of electric energy (reverse direction)".to_string(),
            "".to_string(),
        ...
        obj.add_standard_property(0xE4, "Historical data of measured cumulative amounts of electric energy 1 (reverse direction)".to_string(), "".to_string(), 0, to_attribute("required_c"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xE5, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved 1".to_string(), "".to_string(), 0, to_attribute("required"), to_attribute("required"), to_attribute("optional"));
        obj.add_standard_property(
            0xE7,
            "Measured instantaneous electric power".to_string(),
            "".to_string(),
        ...
        obj.add_standard_property(0xEC, "Historical data of measured cumulative amounts of electric energy 2 (normal and reverse directions)".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("notApplicable"), to_attribute("optional"));
        obj.add_standard_property(0xED, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved 2".to_string(), "".to_string(), 0, to_attribute("optional"), to_attribute("optional"), to_attribute("optional"));
        self.add_object(obj);
    }
}
