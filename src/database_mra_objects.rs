...
impl StandardDatabase {
    ...
    pub fn init_objects(&mut self) {
        ...
        obj.add_standard_property(0xC5, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, property_string_to_attribute("optional"), property_string_to_attribute("optional"), property_string_to_attribute("optional"));
        obj.add_standard_property(
            0xC6,
        ...
        obj.add_standard_property(0xE1, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, property_string_to_attribute("required"), property_string_to_attribute("required"), property_string_to_attribute("optional"));
        obj.add_standard_property(
            0xE2,
        ...
        obj.add_standard_property(0xE0, "Day for which the historical data of measured cumulative amounts of electric energy is to be retrieved".to_string(), "".to_string(), 0, property_string_to_attribute("required"), property_string_to_attribute("required"), property_string_to_attribute("optional"));
        obj.add_standard_property(
            0xE1,
            "Measured cumulative amount of electric energy(normal direction)".to_string(),
            "".to_string(),
