...
impl Object {
    fn add_standard_property(&mut self, code: PropertyCode, name: String, _data_type: String, _data_size: usize, get_rule: PropertyAttr, set_rule: PropertyAttr, anno_rule: PropertyAttr) {
