...
/// StandardDatabase provides a standard database for ECHONET-Lite device objects and manufactures. This standard database was generated by importing official ECHONET Consortium Machine Readable Appendix and Manufacturer code List.
/// # Examples
/// ```
